...
})({"5ep5R":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "68e3a5c3b28bd597";
"use strict";
...
},{}],"9INyo":[function(require,module,exports) {
...
var client = new _sampleSettings.OidcClient(_sampleSettings.settings);
///////////////////////////////
...
function signin() {
    client.createSigninRequest({
        ...
        if (followLinks()) window.location = req.url;
    }).catch(function(err) {
        console.error(err);
        log(err);
    });
...
document.getElementById("processSignout").style.display = display;
if (followLinks()) {
    if (window.location.href.indexOf("#") >= 0) processSigninResponse();
    else if (window.location.href.indexOf("?") >= 0) processSignoutResponse();
}

},{"./sample-settings":"imoE0","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"imoE0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "OidcClient", ()=>_src.OidcClient
);
...
},{}]},["5ep5R","9INyo"], "9INyo", "parcelRequire7bde")

//# sourceMappingURL=sample.b28bd597.js.map
